...
from nnssl.run.load_pretrained_weights import load_pretrained_weights,load_my_pretrained_weights
...
def maybe_load_checkpoint(
    ...
    if continue_training:
        ...
        if pretrained_weights_file is not None:
            ...
            load_my_pretrained_weights(nnunet_trainer.network, pretrained_weights_file, verbose=True)
        expected_checkpoint_file = None
